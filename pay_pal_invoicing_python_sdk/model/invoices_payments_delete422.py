...
class InvoicesPaymentsDelete422(
                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "The external payment cannot be deleted as the recorded refund cannot exceed the recored payment for an invoice.": "THE_EXTERNAL_PAYMENT_CANNOT_BE_DELETED_AS_THE_RECORDED_REFUND_CANNOT_EXCEED_THE_RECORED_PAYMENT_FOR_AN_INVOICE_",
                                                }
                                            
                                            @schemas.classproperty
                                            def THE_EXTERNAL_PAYMENT_CANNOT_BE_DELETED_AS_THE_RECORDED_REFUND_CANNOT_EXCEED_THE_RECORED_PAYMENT_FOR_AN_INVOICE_(cls):
                                                return cls("The external payment cannot be deleted as the recorded refund cannot exceed the recored payment for an invoice.")
                                        ...
                                        class issue(
                                            ...
                                            @schemas.classproperty
                                            def CANNOT_DELETE_EXTERNAL_PAYMENT(cls):
                                                return cls("CANNOT_DELETE_EXTERNAL_PAYMENT")
                                        __annotations__ = {
