...
class DateTimeRange(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def start() -> typing.Type['DateTime']:
                return DateTime
        
            @staticmethod
            def end() -> typing.Type['DateTime']:
                return DateTime
            __annotations__ = {
                "start": start,
                "end": end,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["start"]) -> 'DateTime': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["end"]) -> 'DateTime': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["start"]) -> 'DateTime': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["end"]) -> 'DateTime': ...
