...
class BusinessName(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["business_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["business_name", ], str]):
