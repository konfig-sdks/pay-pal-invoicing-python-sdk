                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "The requested invoice is not associated with the requested user.": "THE_REQUESTED_INVOICE_IS_NOT_ASSOCIATED_WITH_THE_REQUESTED_USER_",
                                                }
                                            
                                            @schemas.classproperty
                                            def THE_REQUESTED_INVOICE_IS_NOT_ASSOCIATED_WITH_THE_REQUESTED_USER_(cls):
                                                return cls("The requested invoice is not associated with the requested user.")
