...
class InvoicesGenerateQrCode400(
                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "Value of the field does not conform to the expected format.": "VALUE_OF_THE_FIELD_DOES_NOT_CONFORM_TO_THE_EXPECTED_FORMAT_",
                                                }
                                            
                                            @schemas.classproperty
                                            def VALUE_OF_THE_FIELD_DOES_NOT_CONFORM_TO_THE_EXPECTED_FORMAT_(cls):
                                                return cls("Value of the field does not conform to the expected format.")
