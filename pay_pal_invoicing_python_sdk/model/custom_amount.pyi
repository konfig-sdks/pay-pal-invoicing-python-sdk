...
class CustomAmount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["label", "amount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["label", "amount", ], str]):
