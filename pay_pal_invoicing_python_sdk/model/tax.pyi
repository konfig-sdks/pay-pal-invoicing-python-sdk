...
class Tax(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "percent", "amount", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["percent"]) -> 'Percentage': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "percent", "amount", ], str]):
