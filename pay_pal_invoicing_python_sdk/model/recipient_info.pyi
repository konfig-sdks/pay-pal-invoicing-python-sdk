...
class RecipientInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def billing_info() -> typing.Type['BillingInfo']:
                return BillingInfo
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["billing_info"]) -> 'BillingInfo': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["billing_info", "shipping_info", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["billing_info"]) -> typing.Union['BillingInfo', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["billing_info", "shipping_info", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        billing_info: typing.Union['BillingInfo', schemas.Unset] = schemas.unset,
