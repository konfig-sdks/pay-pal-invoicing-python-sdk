...
from pay_pal_invoicing_python_sdk.model.qr_config import QrConfig as QrConfigSchema
from pay_pal_invoicing_python_sdk.model.error_default import ErrorDefault as ErrorDefaultSchema
from pay_pal_invoicing_python_sdk.model.invoices_generate_qr_code403_response import InvoicesGenerateQrCode403Response as InvoicesGenerateQrCode403ResponseSchema
from pay_pal_invoicing_python_sdk.model.invoices_generate_qr_code_response import InvoicesGenerateQrCodeResponse as InvoicesGenerateQrCodeResponseSchema

from pay_pal_invoicing_python_sdk.type.error404 import Error404
from pay_pal_invoicing_python_sdk.type.invoices_generate_qr_code403_response import InvoicesGenerateQrCode403Response
from pay_pal_invoicing_python_sdk.type.error_default import ErrorDefault
from pay_pal_invoicing_python_sdk.type.invoices_generate_qr_code_response import InvoicesGenerateQrCodeResponse
from pay_pal_invoicing_python_sdk.type.qr_config import QrConfig
...
from pay_pal_invoicing_python_sdk.pydantic.qr_config import QrConfig as QrConfigPydantic
from pay_pal_invoicing_python_sdk.pydantic.invoices_generate_qr_code403_response import InvoicesGenerateQrCode403Response as InvoicesGenerateQrCode403ResponsePydantic
from pay_pal_invoicing_python_sdk.pydantic.invoices_generate_qr_code_response import InvoicesGenerateQrCodeResponse as InvoicesGenerateQrCodeResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = QrConfigSchema


request_body_qr_config = api_client.RequestBody(
    content={
...
SchemaFor400ResponseBodyMultipartMixed = InvoicesGenerateQrCodeResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: InvoicesGenerateQrCodeResponse
...
SchemaFor403ResponseBodyMultipartMixed = InvoicesGenerateQrCode403ResponseSchema


@dataclass
class ApiResponseFor403(api_client.ApiResponse):
    body: InvoicesGenerateQrCode403Response
    ...
    async def _agenerate_qr_code_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/invoicing/invoices/{invoice_id}/generate-qr-code',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_qr_config.serialize(body, content_type)
