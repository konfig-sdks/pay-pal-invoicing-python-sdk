...
class PartialPayment(BaseModel):
    ...
    allow_partial_payment: typing.Optional[bool] = Field(None, alias='allow_partial_payment')

    minimum_amount_due: typing.Optional[Money] = Field(None, alias='minimum_amount_due')
